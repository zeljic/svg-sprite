...
FLAGS:
    ...
    -r, --recursive    
            Get files from INPUT recursively

    -V, --version      
            Prints version information

    -v                 
            Show more info about files and generated SVG file


OPTIONS:
    -a, --remove-attribute <remove-attribute>...    
            Remove attributes from SVG file. It works only on first level elements.

    -e, --remove-element <remove-element>...        
            Remove elements from svg based on tag name. It works only on first level.
